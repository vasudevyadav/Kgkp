          ...
          <div className="lg:p-8">
            <div className="text-center mb-2">
              <img
                src={JaipurAddresh}
                alt="Realty Logo"
                className="mx-auto lg:w-24 w-12 lg:mb-10 mb-6"
              />
            </div>

            <h3 className="text-center lg:text-4xl text-2xl font-normal text-gray-800 mb-6">
              KGK Realty (INDIA) Limited
            </h3>

            <div className="text-gray-700 text-sm leading-relaxed space-y-4 w-full lg:w-[80%] mx-auto">
