...
const ConstructionUpdate = ({ data }) => {
 ...
 = data;
  ...
  return (
    <section className="bg-[#e6e6e6] lg:pt-16 pt-8 pl-4 md:pl-8">
      <div className="pl-0 lg:pl-20">
        ...
        <div className="grid lg:grid-cols-12 lg:gap-16 gap-10 items-center">
          <div className="lg:col-span-4 space-y-8">
            <div>
              <h3 className="lg:text-2xl text-lg lg:font-semibold text-gray-800 lg:mb-6 -mt-8 mb-2">{Constructionsubtitle}</h3>
              <p className="text-gray-600 leading-relaxed lg:text-base mb-8 lg:w-11/12 pr-4 lg:pr-0">
                {Constructiondescription}
              </p>
