...
const ProjectHeading = ({ variant }) => {
  ...
  const fetchProjects = async () => {
    try {
      ...
      url.searchParams.append('type', variant); // Only get projects matching type
      ...
      setProjects(result?.projects || []); // Adjust key if API returns something else
    } catch (error) {
      ...
      <div className="mx-auto">
        ...
        <div className="mx-auto lg:px-10 px-5">
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-6 lg:mb-1 items-center">
              {/* Left side image */}
                    ...
                    >
                      ...
                      <div className="w-full lg:w-2/3 flex flex-col justify-between">
                        <div className="flex items-center gap-5 justify-between">
                          <div>
                            <h3 className="text-amber-800 font-bold text-xl line-clamp-1 mb-1">
                              {project.name}
                            </h3>
                          ...
                          <Link
                            ...
                            className="border border-black text-black px-6 py-2 text-sm uppercase font-medium hover:bg-amber-800 hover:text-white transition duration-300"
                          >
                            EXPLORE
                          </Link>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-4 mt-4">
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm text-black font-semibold line-clamp-1 ">{project.bedroom}</p>
                          </div>
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm text-black font-semibold line-clamp-1">{project.units}</p>
                          </div>
